...
int adventuererEffect(int currentPlayer, struct gameState *state){
    int drawntreasure = 0;
    int cardDrawn = 0;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
        return adventuererEffect(currentPlayer, state);

    case council_room:
        return councilRoomEffect(currentPlayer, handPos, state);
			
    case feast:
        return feastEffect(currentPlayer, choice1, state);
    ...
    case remodel:
      return  remodelEffect(currentPlayer, choice1, choice2, handPos, state);

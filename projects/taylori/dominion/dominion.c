...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
            adventurerCard(state, currentPlayer, handPos, drawntreasure, cardDrawn, temphand, z);
        return 0;
    ...
    case mine:
            mineCard(state, currentPlayer, handPos, i, j, choice1, choice2);
        return 0;
...
int mineCard(struct gameState *state, int currentPlayer, int handPos, int i, int j, int choice1, int choice2){
    j = state->hand[currentPlayer][choice1];  //store card we will trash

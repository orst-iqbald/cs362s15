...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case adventurer:
      ...
      return 0;   //End adventurer card.
		
    // coucncil_room description.
    case council_room:
      //+4 Cards
      for (i = 0; i < 4; i++)
    	{
      ...
      return 0;   //End council_room section.
	...
	else
  {
    ...
    case smithy:
      //+3 Cards    void smithyCard(struct gameState *state, int currentPlayer, int handPos)
        smithyCard(state, currentPlayer, handPos);

      return 0;   //End of the smithy card case.
...
void adventurerCard(struct gameState *state, int currentPlayer, int z, int *temphand)
{
  int drawntreasure = 0;
  int cardDrawn;

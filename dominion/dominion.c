...
void adventurer_card(struct gameState *state, int *temphand, int drawntreasure, int z, int currentPlayer, int cardDrawn)
{
...
void council_room_card(int handPos, int currentPlayer, struct gameState *state) 
{
      int i;
      //+4 Cards
      for (i = 0; i < 4; i++)
...
void cutpurse_card(int handPos, int currentPlayer, struct gameState *state)
{  
      int i, j, k;
...
void minion_card(struct gameState *state, int currentPlayer, int handPos, int choice1, int choice2)
{
      int i, j;
      //+1 action
      state->numActions++;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      adventurer_card(state, temphand, drawntreasure, z, currentPlayer, cardDrawn);
      return 0;
			
    case council_room:
      council_room_card(handPos, currentPlayer, state);
      return 0;
    ...
    case cutpurse:
      cutpurse_card(handPos, currentPlayer, state);
      return 0;

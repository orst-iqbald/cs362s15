...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case remodel:
            if ( remodelFunc(state, currentPlayer, handPos, choice1, choice2) < 0 )
            {
                return -1;
            }
            return 0;
    ...
    case minion:
        minionFunc(state, currentPlayer, handPos, choice1, choice2);
      return 0;
		
    case steward:
        stewardFunc(state, currentPlayer, handPos, choice1, choice2, choice3);
      return 0;

...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
	...
	{
		case adventurer:
			return h_adventurer(currentPlayer, state);
		...
		case smithy:
			return h_smithy(handPos, currentPlayer, state);
		...
		case steward:
			return h_steward(choice1,choice2,choice3,handPos,currentPlayer,state);
		...
		case outpost:
			return h_outpost(handPos,currentPlayer,state);
		...
		case sea_hag:
			return h_sea_hag(currentPlayer,state);
...
int h_smithy(int handPos, int currentPlayer, struct gameState *state){
	//+3 Cards
	int i = 0;
	for (i = 0; i < 3; i++)
	{
...
int h_adventurer(int currentPlayer, struct gameState *state){
	int z = 0;
	int drawntreasure = 0;
	int cardDrawn = 0;
	int temphand[MAX_HAND];// moved above the if statement
...
int h_steward(int choice1, int choice2, int choice3, int handPos, int currentPlayer, struct gameState *state){
	if (choice1 == 1)
	{
		//+2 cards
		drawCard(currentPlayer, state);
...
int h_sea_hag(int currentPlayer, struct gameState *state){
	int i = 0;
	for (i = 0; i < state->numPlayers; i++){
		if (i != currentPlayer){

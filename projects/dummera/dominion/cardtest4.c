...
int testGreat_hallCard(int currentPlayer, struct gameState *post, int handPos){
        int i, result;
        ...
        //+3 Cards
        drawCard(currentPlayer, post);//error, this should not be commented out

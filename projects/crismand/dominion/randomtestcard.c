/*
************************************
This is a random tester for the method pCouncilRoom() from dominion.c  
pCouncilRoom stands for Play Council Room

It initializes a gameState, randomizes a bunch of things in the state (but not anything that completely breaks
the code.  Then it calls pCouncilRoom, then checks the results.  
...
int main(int argc, char *argv[]) {
	...
	for(i = 1; i <= tests; ++i){
		...
		res = pCouncilRoom(G1, (G1->handCount[0] - 1));

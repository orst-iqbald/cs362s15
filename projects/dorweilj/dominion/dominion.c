...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      adventurer_refact(currentPlayer, state);
      return 0;
    ...
    case smithy:
      smithy_refact(currentPlayer, handPos, state);
      return 0;
		
    case village:
      village_refact(currentPlayer, handPos, state);
      return 0;
    ...
    case minion:
      minion_refact(choice1, choice2, state, handPos);
      return 0;
    ...
    case outpost:
      outpost_refact(currentPlayer, handPos, state);
      return 0;
...
void minion_refact(int choice1, int choice2, struct gameState *state, int handPos){
...
void village_refact(int currentPlayer, int handPos, struct gameState *state){
  //+1 Card
  drawCard(currentPlayer, state);
...
void outpost_refact(int currentPlayer, int handPos, struct gameState *state){
  //set outpost flag
  state->outpostPlayed++;

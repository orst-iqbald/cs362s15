...
int myAdventurerCard(struct gameState *state, int currentPlayer){
	int z = 0; // Count var for curr hand.
	int cardDrawn;
	int drawntreasure = 0;
...
int mySmithyCard(struct gameState *state, int currentPlayer, int handPos){
	int i;
	//+3 Cards
      for (i = 0; i <= 3; i++)
	{
...
int myGreat_hallCard(struct gameState *state, int currentPlayer, int handPos){
	//+1 Card
      drawCard(currentPlayer, state);
...
int myOutpostCard(struct gameState *state, int currentPlayer, int handPos){
	//set outpost flag
      state->outpostPlayed++;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      return myAdventurerCard(state, currentPlayer);
    ...
    case smithy:
      return mySmithyCard(state, currentPlayer, handPos);
    ...
    case great_hall:
      return myGreat_hallCard(state, currentPlayer, handPos);
    ...
    case outpost:
      return myOutpostCard(state, currentPlayer, handPos);

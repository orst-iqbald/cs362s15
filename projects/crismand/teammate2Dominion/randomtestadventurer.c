/*
************************************
This is a random tester for the method effectAdventurer() from dominion.c  
effectAdventurer stands for Play Adventurer

It initializes a gameState, randomizes a bunch of things in the state (but not anything that completely breaks
the code.  Then it calls effectAdventurer, then checks the results.  
...
int main(int argc, char *argv[]) {
	...
	for(i = 1; i <= tests; ++i){
		...
		res = effectAdventurer(G1, (G1->handCount[0] - 1));

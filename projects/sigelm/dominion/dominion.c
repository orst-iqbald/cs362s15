...
int adventurerCard(int drawntreasure, int currentPlayer, struct gameState *state, int z, int temphand[])
{
    int cardDrawn; //initializing cardDrawn here and an unused cardDrawn below in the original cardEffect section
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  int drawntreasure=0;
  int cardDrawn; //unused define cardDrawn, was defined in above adventurer card function

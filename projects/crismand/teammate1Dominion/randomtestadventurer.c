/*
************************************
This is a random tester for the method cardAdventurer() from dominion.c  
...
the code.  Then it calls cardAdventurer, then checks the results.  
...
int main(int argc, char *argv[]) {
	...
	for(i = 1; i <= tests; ++i){
		...
		res = cardAdventurer(G1->whoseTurn, G1);

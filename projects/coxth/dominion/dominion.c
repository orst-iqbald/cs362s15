...
int mineCard(struct gameState *state, int handPos, int currentPlayer, int choice1, int choice2){
  int i;
  int j;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  int returnValue = 0;    //this is set equal to the return value of the function call
  ...
  switch( card ) 
    {
    case adventurer:
	  returnValue = adventurerCard(state, handPos, currentPlayer);
      return returnValue;
    ...
    case mine:
	  returnValue = mineCard(state, handPos, currentPlayer, choice1, choice2);
      return returnValue;
			
    case remodel:
	  returnValue = remodelCard(state, handPos, currentPlayer, choice1, choice2);
      return returnValue;
		
    case smithy:
	   returnValue = smithyCard(state, handPos, currentPlayer);
       return returnValue;
    ...
    case steward:
	  returnValue = stewardCard(state, handPos, currentPlayer, choice1, choice2, choice3);
      return returnValue;

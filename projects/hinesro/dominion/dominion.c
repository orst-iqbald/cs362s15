...
// Effects function declarations
int callSmithy(struct gameState *state, int handPos);
int callAdventurer(struct gameState *state, int handPos);
int callCouncilRoom(struct gameState *state, int handPos);
int callGreatHall(struct gameState *state, int handPos);
int callCutpurse(struct gameState *state, int handPos);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      callAdventurer(state, handPos);
      return 0;
      
    case council_room:
      callCouncilRoom(state, handPos);
      return 0;

...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      newAdventurer(drawntreasure, currentPlayer, cardDrawn, temphand, z, state);
      return 0;
			
    case council_room:

	  newCouncilRoom(i, currentPlayer, handPos, state);
      return 0;
    ...
    case smithy:
      newSmithy(i, currentPlayer, handPos, state);
      return 0;
